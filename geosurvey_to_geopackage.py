...
if __name__ == "__main__":
    ...
    with collection(
        "downloaded_data/downloaded_data_polygons.gpkg",
        "w",
        driver="GPKG",
        crs=crs,
        layer="polygons",
        schema=schema_polygon,
    ) as c:
                    ...
                    c.write(
                        {
                            ...
                            "properties": {
                                "id": curPoly["id"],
                                "comment": curPoly["comment"],
                                "category": curPoly["category"],
                                "date_added": curPoly["date_added"],
                            },
                        }
                    )
    ...
    with collection(
        "downloaded_data/downloaded_data_lines.gpkg",
        "w",
        driver="GPKG",
        crs=crs,
        layer="polygons",
        schema=schema_polyline,
    ) as c:
                ...
                c.write(
                    {
                        ...
                        "properties": {
                            "id": cur_line["id"],
                            "comment": cur_line["comment"],
                            "category": cur_line["category"],
                            "date_added": cur_line["date_added"],
                        },
                    }
                )
